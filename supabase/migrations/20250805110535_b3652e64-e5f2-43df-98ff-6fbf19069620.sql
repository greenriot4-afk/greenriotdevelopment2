-- Solo crear lo necesario sin duplicar el wallet existente
...
-- Convertir balance de USD a EUR (simulando 4.75 EUR como $4.75 para simplicidad)
...
-- Crear transacción de comisión en USD
INSERT INTO transactions (
    ...
    4.75,
    'completed',
    'Affiliate commission for referring jaime@gmail.com (EUR converted to USD)',
