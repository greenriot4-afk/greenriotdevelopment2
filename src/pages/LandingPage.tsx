...
export default function LandingPage() {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <section className="relative h-screen bg-contain bg-center bg-no-repeat overflow-hidden" style={{backgroundImage: "url('/lovable-uploads/33b0365e-92d9-4d4e-92b6-a0aa81533bb6.png')", backgroundColor: '#17503a'}}>
