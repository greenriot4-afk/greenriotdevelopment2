      ...
      <div className="container mx-auto px-3 sm:px-4 lg:px-6">
        <div className="flex items-center justify-between h-16 sm:h-18 lg:h-20">
          ...
          <div className="hidden lg:flex items-center space-x-6 xl:space-x-8">
            {/* CTA Button */}
            <Button asChild className="bg-accent hover:bg-accent/90 text-primary font-impact text-rebel shadow-rebel px-6 py-2.5 text-sm xl:text-base">
          ...
          <div className="hidden md:flex lg:hidden items-center space-x-4">
            {/* CTA Button */}
            <Button asChild size="sm" className="bg-accent hover:bg-accent/90 text-primary font-impact text-xs px-4 py-2">
              <Link to="/app/abandons">
          ...
          <div className="md:hidden flex items-center space-x-2 sm:space-x-3">
            {/* Mobile CTA Button */}
            <Button asChild size="sm" className="bg-accent hover:bg-accent/90 text-primary font-impact text-xs px-2 sm:px-3 py-1.5 sm:py-2 min-w-0">
              <Link to="/app/abandons">
